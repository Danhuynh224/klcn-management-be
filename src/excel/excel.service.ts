    ...
    return [
      {
        ...
        actor: 'STUDENT',
        color: 'warning',
        nextStatuses: `${RegistrationStatus.BCTT_APPROVED},${RegistrationStatus.BCTT_REJECTED}`,
      ...
      },
      {
        id: 'wf_bctt_rejected',
        loai: RegistrationType.BCTT,
        status: RegistrationStatus.BCTT_REJECTED,
        label: 'BCTT bị từ chối',
        description:
          'Giảng viên hướng dẫn đã từ chối đăng ký BCTT của sinh viên.',
        step: 1,
        stepLabel: 'Đăng ký',
        actor: 'LECTURER',
        color: 'danger',
      ...
      },
      {
        ...
        actor: 'STUDENT',
        color: 'warning',
        nextStatuses: `${RegistrationStatus.KLTN_APPROVED},${RegistrationStatus.KLTN_REJECTED}`,
        canStudentUpdate: false,
        canLecturerUpdate: true,
        canManagerUpdate: true,
        isTerminal: false,
      ...
      },
      {
        id: 'wf_kltn_rejected',
        loai: RegistrationType.KLTN,
        status: RegistrationStatus.KLTN_REJECTED,
        label: 'KLTN bị từ chối',
        description:
          'Giảng viên hướng dẫn đã từ chối đăng ký KLTN của sinh viên.',
        step: 1,
        stepLabel: 'Đăng ký',
        actor: 'LECTURER',
        color: 'danger',
      ...
      },
      {
        ...
        actor: 'LECTURER',
        color: 'info',
        nextStatuses: `${RegistrationStatus.WAITING_COMMITTEE_ASSIGNMENT},${RegistrationStatus.WAITING_COMMITTEE_SCORE}`,
        canStudentUpdate: false,
        canLecturerUpdate: true,
        canManagerUpdate: true,
        isTerminal: false,
      ...
      {
        id: 'wf_kltn_committee_assignment',
        loai: RegistrationType.KLTN,
        status: RegistrationStatus.WAITING_COMMITTEE_ASSIGNMENT,
        label: 'Chá» phÃ¢n cÃ´ng há»™i Ä‘á»“ng',
        description: 'ÄÃ£ cÃ³ Ä‘iá»ƒm pháº£n biá»‡n nhÆ°ng chÆ°a Ä‘Æ°á»£c gÃ¡n há»™i Ä‘á»“ng.',
        step: 6,
        stepLabel: 'PhÃ¢n há»™i Ä‘á»“ng',
        actor: 'MANAGER',
        color: 'warning',
